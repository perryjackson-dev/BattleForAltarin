...
export const gameStateSchema = z.object({ version: z.literal(1), wood: z.number().nonnegative(), stone: z.number().nonnegative(), populationCapacity: z.number().nonnegative(), plot })
